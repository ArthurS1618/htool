...
#define HTOOL_GENERATE_EXTERN_LAPACK_COMPLEX(C, T, B, U)                                                                                                                            \
    ...
    void HTOOL_LAPACK_F77(B##geqrf)(const int *, const int *, U *, const int *, U *, U *, const int *, int *);                                                                      \
    void HTOOL_LAPACK_F77(B##orgqr)(const int *, const int *, const int *, U *, const int *, U *, U *, const int *, int *);
...
struct Lapack {
    ...
    /// alors il y a 14 paramètres dans gesvd donc je dais pas ce que ca fait cette fonction
    ...
    static void orgqr(const int *, const int *, const int *, K *, const int *, K *, K *, const int *, int *);
};
...
#    define HTOOL_GENERATE_LAPACK_COMPLEX(C, T, B, U)                                                                                                                                                                             \
        ...
        template <>                                                                                                                                                                                                               \
        inline void Lapack<U>::orgqr(const int *m, const int *n, const int *k, U *a, const int *lda, U *tau, U *work, const int *lwork, int *info) {                                                                              \
            HTOOL_LAPACK_F77(B##orgqr)                                                                                                                                                                                            \
