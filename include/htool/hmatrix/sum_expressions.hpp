                        ...
                        if ((Htr->is_low_rank()) and !(Krs->is_low_rank())) {
                            ...
                            if (Htr->get_source_cluster().get_size() == Krs->get_target_cluster().get_size()) {
                                ...
                                if (Uh.nb_rows() == target_0) {
                                    ...
                                    for (int kk = 0; kk < target_0; ++kk) {
                                        for (int l = 0; l < Uh.nb_cols(); ++l) {
                                            urestrh(kk, l) = Uh(kk + target_offset0 - Htr->get_target_cluster().get_offset(), l);
                                        }
                                    }
                                }
                                if (Vh.nb_cols() == rho_child->get_size()) {
                                    ...
                                    for (int kk = 0; kk < Vh.nb_rows(); ++kk) {
                                        for (int l = 0; l < rho_child->get_size(); ++l) {
                                            vrestrh(kk, l) = Vh(kk, l + rho_child->get_offset() - Htr->get_source_cluster().get_offset());
                                        }
                                    }
                                }
                                if (Uk.nb_rows() == rho_child->get_size()) {
                                    ...
                                    for (int kk = 0; kk < rho_child->get_size(); ++kk) {
                                        for (int l = 0; l < Uk.nb_cols(); ++l) {
                                            urestrk(kk, l) = Uk(kk + rho_child->get_offset() - Krs->get_source_cluster().get_offset(), l);
                                        }
                                    }
                                }
                                if (Vk.nb_cols() == source_0) {
                                    ...
                                    for (int kk = 0; kk < Vk.nb_rows(); ++kk) {
                                        for (int l = 0; l < source_0; ++l) {
                                            vrestrk(kk, l) = Vk(kk, l + target_offset0 - Krs->get_source_cluster().get_offset());
                                        }
                                    }
                                }
...
//     int get_target_size() const { return target_size; }
//     int get_source_size() const { return source_size; }
//     bool is_restrectible() const { return restrictibe; }
