...
class SumExpression : public VirtualGenerator<CoefficientPrecision> {
  ...
  public:
    ...
    std::vector<LowRankMatrix<CoefficientPrecision, CoordinatePrecision>> get_sr() const { return Sr; }
    std::vector<HMatrix<CoefficientPrecision, CoordinatePrecision> *> get_sh() const { return Sh; }
